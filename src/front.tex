...
% color options
\definecolor{seplinecolor}{HTML}{357f2d}  % green
\definecolor{iconcolor}{HTML}{2f3142}     % dark
\definecolor{textcolor}{HTML}{2f3142}     % dark
\definecolor{jobtitlecolor}{HTML}{474a65} % light dark
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix[every node/.style={anchor=center,font=\huge},anchor=center] (name) {
        \node{Jacob}; \\
        \node{Mischka}; \\
        \node{\color{jobtitlecolor}\normalsize\textit{Software developer}}; \\
      };
      % sep line 1
      \node[below=\seplinedistance of name] (hl1) {};
      \draw[line width=\seplineheight,color=seplinecolor] (hl1)++(-\seplinewidth/2,0) -- ++(\seplinewidth,0);
      % contact info
      \matrix [below=\seplinedistance of hl1,%
               column 1/.style={anchor=center,color=iconcolor},%
      ...
      \draw[line width=\seplineheight,color=seplinecolor] (hl2)++(-\seplinewidth/2,0) -- ++(\seplinewidth,0);
      % interests
